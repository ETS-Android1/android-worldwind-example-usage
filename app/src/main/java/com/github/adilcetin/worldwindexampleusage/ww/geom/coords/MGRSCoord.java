...
public class MGRSCoord {
    ...
    public static MGRSCoord fromLatLon(Double latitude, Double longitude)
    {
        ...
        return MGRSCoord.fromLatLon(Angle.fromDegrees(latitude), Angle.fromDegreesLongitude(longitude));
    }
    ...
    public static MGRSCoord fromLatLon(Angle latitude, Angle longitude, Globe globe, int precision)
    {
        ...
        {
            throw new IllegalArgumentException("Coord.MGRSConversionError");
        }

        return new MGRSCoord(latitude, longitude, converter.getMGRSString(), converter.getZone(), converter.getEasting(), converter.getNorthing());
    }
    ...
    public MGRSCoord(Angle latitude, Angle longitude, String MGRSString)
    {
        ...
        {
            throw new IllegalArgumentException("generic.StringIsEmpty");
        }
    ...
    public MGRSCoord(Angle latitude, Angle longitude, String MGRSString, String zone, String easting, String northing)
    {
        if (latitude == null || longitude == null)
        {
            throw new IllegalArgumentException("nullValue.LatitudeOrLongitudeIsNull");
    ...
    public String getEasting(){ return this.easting; }

    public String getNorthing(){ return this.northing; }

    public double getLatitude(){ return this.latitude.getDegrees(); }

    public double getLongitude(){ return this.longitude.getDegrees(); }
