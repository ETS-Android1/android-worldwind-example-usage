...
public class MilStd2525 {
    ...
    private final static int DEFAULT_FONT_SIZE = 28;
    ...
    public static Bitmap symbolToBitmap(String symbolCode){
        SymbolBitmapFactory factory = new SymbolBitmapFactory(symbolCode, new SparseArray<>(), null, new PlacemarkAttributes());
        return Bitmap.createScaledBitmap(factory.createBitmap(), 128, 128, false);
    }
